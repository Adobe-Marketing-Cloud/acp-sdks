...
namespace AdobeMarketingMobile {
    ...
    public:
        ...
        */
        ...
        /**
         * @brief Check if a string starts with prefix
         *
         * @param str string to check prefix
         * @param prefix the prefix string
         * @return bool whether the string str starts with the prefix
         */
         ...
         *
         * Notes: the default std::locale is being used when transform the string, Unicode may or may not be supported
         *
