...
namespace AdobeMarketingMobile {
    ...
    public:
         ...
         *
         * @param name - a description of the listener for debugging purposes
         * @param listener - The listener to invoke.
         */
        virtual void RegisterOneTimeNetworkConnectionStatusListener(const std::string& name,
                const std::function<void()>& listener) const = 0;
         ...
         */
        virtual std::string GetApplicationBundleId() const = 0;

        /**
         * Returns the device type
         *
         * @return SystemInfoService::DeviceType.
         */
        virtual SystemInfoServiceInterface::DeviceType GetDeviceType() const = 0;

        /**
         * Returns the current orientation of the device
         *
         * @return SystemInfoServiceInterface::DeviceOrientation
         */
        virtual SystemInfoServiceInterface::DeviceOrientation GetCurrentOrientation() const = 0;
         ...
         * @return Locale name.
         */
        virtual std::string GetActiveLocaleName() const = 0;
