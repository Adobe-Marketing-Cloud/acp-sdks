...
namespace AdobeMarketingMobile {
    ...
    public:
         ...
         *
         *
         * @param event_type - the event type to listen for; it should not be empty string
         * @param event_source - the event source to listen for; it should not be empty string
         * @throw SDKError if the event type or source are empty strings
         *
