...
namespace AdobeMarketingMobile {
    ...
    private:
         ...
         *
         * @return  std::string containing the current date and time in the ISO 8601 date and time format.
         * @see TimeUtil#getIso8601Date()
         */
    ...
    private:
        ...
        static const std::string KEY_TIMESTAMP_ISO8601;
        ...
        std::shared_ptr<PlatformServicesInterface> platform_services_;  ///< platform services provide access to sdk version
