...
namespace AdobeMarketingMobile {
    ...
    public:
         ...
         * @param completed - callback function called when download has completed or failed
         */
        virtual void GetFileAsyncWithProperties(const std::string& cache_subfolder,
                                                const std::string& url,
                                                const std::map<std::string, std::string>& request_property,
                                                const std::function<void(const Expected<std::shared_ptr<RemoteFileInterface>>&)>& completed) = 0;
         ...
         * @return ptr to RemoteFileInterface or SdkError
         */
        virtual Expected<std::shared_ptr<RemoteFileInterface>> GetFileSyncWithProperties(const std::string& cache_subfolder,
                const std::string& url,
                const std::map<std::string, std::string>& request_property) = 0;
