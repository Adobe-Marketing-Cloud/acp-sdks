...
namespace AdobeMarketingMobile {
    ...
    public:
        /**
         * @brief Merges the contents of another EventData instance into this EventData
         *
         * @discussion This method will merge all members of the other_data EventData object into the calling
         * EventData object.  When an identical key exists in both instances, this instance will take priority.
         */
        void Merge(const std::shared_ptr<EventData>& other_data);

        /**
         * @brief Returns a pretty string representation of internal_map_
         *
         * @param indent_depth represents how many tabs of whitespace should be used for the initial depth of indentation
         * @return A pretty string representing internal_map_
         */
        std::string PrettyString(int32_t indent_depth);
    };
