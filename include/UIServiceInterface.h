...
namespace AdobeMarketingMobile {
    ...
    /**
     * Object defining the arguments used to create a local notification message
     */
    class ShowLocalNotificationArgs : public Object {
    public:
        static std::shared_ptr<ShowLocalNotificationArgs> Create();
    ...
    public:
         ...
         * Display a local notification
         *
         * @param localNotificationArgs     Local notification argument object containing the necessary parameters to create a local notification message
         */
        virtual void ShowLocalNotification(const std::shared_ptr<ShowLocalNotificationArgs>& localNotificationArgs) = 0;
    };
} // namespace
