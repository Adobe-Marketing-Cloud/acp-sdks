...
namespace AdobeMarketingMobile {
    ...
    public:
         ...
         */
        ADOBE_DEPRECATED(bool IsInternal());
    ...
    private:
        ...
        /**
         * @private
         * @return the parent event hub (thread safe).
         */
        std::shared_ptr<EventHub> GetEventHub();
        ...
        static_assert(sizeof(std::shared_ptr<PlatformServicesInterface>) == sizeof(std::weak_ptr<PlatformServicesInterface>),
                      "ABI Change");
    ...
    protected:
        /**
         *
         * Dispatch an event and share state at the same time.
         * @param state State to share. state will have the event number of passed in event's eventual event number.
         * @param event event to dispatch
         */
        ADOBE_VIRTUAL_FOR_TESTS void CreateSharedStateAndDispatchEvent(const std::shared_ptr<EventData>& state,
                const std::shared_ptr<Event>& event);
         ...
         *
         */
        ADOBE_VIRTUAL_FOR_TESTS void ReplaceRulesSet(const std::vector<std::shared_ptr<Rule>> rules_vector);
