...
#pragma mark - std::map, NSDictionary
    ...
    /**
     * Returns a copy of the provided dictionary, removing entries
     * for which key is not of type NSString.
     *
     * @param dictionary NSDictionary to clean
     * @param removed_entries contains removed entries from data
     */
    NSDictionary* _Nonnull CleanDictionaryKeys(NSDictionary* _Nonnull dictionary,
            NSDictionary* _Nonnull* _Nullable removed_entries);
...
#pragma mark - C++ primitives, NSNumber
    ...
    /**
     * NSTimeInterval to std::chrono::seconds
     */
    std::chrono::seconds ToSeconds(NSTimeInterval ts);
    ...
    /**
     * LoggingMode to ACPMobileLogLevel
     */
    ACPMobileLogLevel ToACPMobileLogLevel(const LoggingMode logLevel);

    /**
     * ACPMobileWrapperType to WrapperType
     */
    NSString* _Nonnull StringFromWrapperType(const ACPMobileWrapperType wrapperType);
}
